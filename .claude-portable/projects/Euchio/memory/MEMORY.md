...
- [Project: LISHI LASER Website](project_lishi_laser.md) — gasmixtech.com, static HTML/CSS site on Cloudflare Pages
- [User Profile](user_profile.md) — Euchio, laser equipment business, bilingual
- [Technical Decisions](tech_decisions.md) — deployment, forms, design choices
- [Design Direction](design_direction.md) — industrial dark theme, red primary, no emojis
- [Feedback: Trusted section](feedback_trusted_section.md) — keep marketing-first, avoid specific agent names
- [Pending Action](pending_action.md) — check Google Search Console structured data fix result
