# LISHI LASER LinkedIn 冷启动执行方案

> 目标: 30 天内建立 LinkedIn 品牌存在，触达 50+ 目标客户
> 核心渠道: 个人 Profile（~5000 followers）为主，公司页面为辅
> 方式: 半自动化 — 内容我来写，审核和发布你来手动操作
> 日投入: 你每天 15-30 分钟
...
> 公司页面已存在: https://www.linkedin.com/company/euchio/
...
### 关键设置
- [ ] 添加 `gasmixtech.com` 链接
- [ ] 添加 LinkedIn Page verification（如有条件）
- [ ] 关联你的个人 Profile 为页面管理员

---

## Step 2: 个人 Profile 优化（第一天完成）

> 个人 Profile: https://www.linkedin.com/in/josephji/

### Headline
> Gas Mixing Technology | Helping Sheet Metal Fabricators Cut 3x Faster @ LISHI LASER

### About 段落（添加在个人简介末尾）
> I represent LISHI LASER, a specialized brand focused on N₂/O₂ mixed gas systems for high-power fiber laser cutting. If you're running 12kW+ laser machines and want to cut faster, cleaner, and cheaper — let's talk.

### Featured Section
添加网站链接 `gasmixtech.com` 和 LinkedIn 公司页面链接
...
### 发布节奏
- 每周 3 帖：周二、周三、周四（LinkedIn B2B 最佳时间）
- 发布时间：北京时间 16:00（对应欧洲 10:00 / 美国东部 04:00）
  - 如果优先欧洲市场：北京时间 16:00
  - 如果优先美国市场：北京时间 22:00
...
| 7 | Tue W3 | 个人 | 图文 | ROI 数字 — 到底省多少钱？ |
| 8 | Wed W3 | 个人 | 图文 | 一拖二 — 一台设备供两台激光 |
| 9 | Thu W3 | 个人 | 图文 | 真实客户案例（Southeast Asia） |
| 10 | Tue W4 | 个人 | 图文 | 行业趋势 — 60kW 时代来了 |
| 11 | Wed W4 | 个人 | 互动 | 氮气涨价你怎么应对？ |
| 12 | Thu W4 | 个人 | 文章 | LinkedIn Article 深度技术长文 |
| 13-15 | W5+ | 个人 | 图文 | 行业趋势、技术问答、案例展示轮动 |

> **发布流程**: 个人账号发布 → 公司页面转发/分享该帖子（2 分钟操作）
...
### Post 3 — 混气技术科普（Day 3, 周四）

**配图**: 设备原理示意图（如果手头没有，可以手绘拍照，手绘反而更真实）
**发布账号**: 个人 Profile
...
### Post 4 — 混气 vs 纯氧 数据对比（Day 4, 周二）

**配图**: 两张切割效果对比照片（纯氧 vs 混气）
**发布账号**: 个人 Profile
...
### Post 5 — 混气 vs 空压机（Day 5, 周三）

**配图**: 两张切割边缘特写对比（空气切割的毛刺 vs 混气切割的光滑）
**发布账号**: 个人 Profile
...
**PDF Page 2 — 对比数据**:
```
CUTTING SPEED COMPARISON (6mm CS, 20kW)

Pure O₂:    2.1 m/min  ████████░░░░░░░
Air:         7.2 m/min  ████████████████████████████░░
Mixed Gas:   6.8 m/min  ██████████████████████████░░░░

Edge quality — Mixed Gas wins.
```

**PDF Page 3 — 成本对比**:
```
ANNUAL GAS COST (single shift, 12kW)

Pure N₂:  $28,000
Mixed Gas: $18,700  → Save $9,300/year

Plus: 3x faster = 3x more output per shift
```
...
### Post 8 — 一拖二配置（Day 8, 周三）

**配图**: 示意图 — 一台混气设备 → 分两路 → 两台不同功率的激光机
**发布账号**: 个人 Profile
...
### Post 10 — 行业趋势（Day 10, 周二）

**配图**: 激光功率演进图表 12kW → 20kW → 30kW → 60kW
**发布账号**: 个人 Profile
...
### 搜索关键词（在 LinkedIn 搜索栏使用）

按职位搜索：
```
"Plant Manager" AND "sheet metal"
"Production Manager" AND "laser cutting"
"CEO" AND "metal fabrication"
"Operations Director" AND "manufacturing"
"Purchasing Manager" AND "industrial"
```

按公司搜索：
```
"sheet metal fabrication" (筛选: 51-200 employees)
"laser cutting service"
"metal processing"
"steel fabrication"
"contract manufacturing" AND "laser"
```

### Connection Request 话术（选一个，复制粘贴）

**话术 A — 直接型**:
```
Hi [Name], I see you're in sheet metal fabrication at [Company]. I run a laser assist gas technology company that helps shops cut 3x faster. Would be great to connect and share our cutting performance data.
```

**话术 B — 内容型**:
```
Hi [Name], came across [Company]'s work in [specific project/post]. We work with laser cutting shops on reducing gas costs and improving cut speed — thought our R&D might be relevant to you. Happy to connect.
```

**话术 C — 极简型**:
```
Hi [Name], I work in laser cutting gas technology and follow what [Company] is doing in the metal fabrication space. Would be great to connect.
```

### 每日 15 分钟互动清单

1. **发 5 条连接请求** → 用上面的话术，选近期活跃的目标用户（2 分钟）
2. **评论 3 条行业帖子** → 搜索 #lasercutting #sheetmetal，认真评论（8 分钟）
3. **查看通知回复** → 有人接受连接或评论就回复（3 分钟）
4. **记录** → 在追踪表记录新连接（2 分钟）

### 目标行业群组（按区域）

**欧洲**:
- Sheet Metal Fabrication Europe
- Laser Cutting & Welding Professionals
- European Manufacturing Network

**美国**:
- Sheet Metal Fabricators Network
- Fiber Laser Cutting Technology
- US Manufacturing & Fabrication

**亚洲**:
- Laser Cutting Technology Asia
- Sheet Metal & Fabrication Asia Pacific

> ⚠️ 入群后先观察 2-3 天再发言，不要直接推销。先回答别人的问题，建立信任。
...
| 层级 | Hashtag | 用途 |
|------|---------|------|
| 核心 | `#lasercutting` | 最大流量池，必加 |
| 行业 | `#sheetmetal` `#metalworking` | 精准人群 |
| 技术 | `#fiberlaser` `#lasertechnology` | 技术决策者 |
| 商业 | `#manufacturing` `#fabrication` | 工厂主/管理层 |
| 利基 | `#assistgas` `#lasercuttinggas` | 极小但高度相关 |

### 每周轮换组合
- 周二（技术帖）: `#lasercutting #fiberlaser #lasertechnology #sheetmetal #manufacturing`
- 周三（互动帖）: `#lasercutting #sheetmetal #metalworking #fabrication #cnc`
- 周四（商业帖）: `#lasercutting #manufacturing #sheetmetal #ROI #fabrication`

---

## Step 7: 成功指标（第 30 天检查）
...
### 月度复盘动作
1. 导出 LinkedIn 帖子数据
2. 标记 TOP 3 表现最好和最差的帖子
3. 为什么好的好？差在哪？调整下月内容
4. 更新目标客户追踪表：谁回复了？谁访问了网站？

---

## 附录: 备选帖子选题库（第 2-3 个月使用）

- 60kW 超高功率切割效果展示
- 常见问答系列（4-5 篇，从网站 FAQ 改写）
- 不同材料（碳钢/不锈钢/铝）切割参数对比
- 液氮 vs 瓶装氮气成本分析
- 季节对激光切割的影响 + 混气如何稳定输出
- 代理商/经销商招募帖
- 展会参展预告（如果有计划）
