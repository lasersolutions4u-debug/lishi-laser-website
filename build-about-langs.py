...
BODY_TRANSLATIONS = {
    'zh': {
        ...
        'why5_title': '兼容您的机器',
        'why5_desc': '大族、DNE、PENTA、LEAD、HSG、BODOR — 如果您的机器使用标准辅助气体接口，就兼容。我们会在您购买前确认。',
    ...
    'es': {
        ...
        'why5_desc': 'HAN\'S, DNE, PENTA, LEAD, HSG, BODOR — si su máquina usa conexiones de gas auxiliar estándar, es compatible. Lo confirmaremos antes de que compre.',
    ...
    'de': {
        ...
        'why5_desc': 'HAN\'S, DNE, PENTA, LEAD, HSG, BODOR — wenn Ihre Maschine Standard-Hilfsgasanschlüsse verwendet, ist sie kompatibel. Wir bestätigen es vor dem Kauf.',
    ...
    'fr': {
        ...
        'why5_desc': 'HAN\'S, DNE, PENTA, LEAD, HSG, BODOR — si votre machine utilise des connexions de gaz auxiliaire standard, elle est compatible. Nous confirmerons avant que vous achetiez.',
    ...
    'ja': {
        ...
        'why5_desc': 'HAN\'S、DNE、PENTA、LEAD、HSG、BODOR — 標準的な補助ガス接続を使用する機械なら互換性があります。購入前に確認します。',
    ...
    'ru': {
        ...
        'why5_desc': 'HAN\'S, DNE, PENTA, LEAD, HSG, BODOR — если ваша машина использует стандартные соединения вспомогательного газа, она совместима. Мы подтвердим перед покупкой.',
...
def apply_translations(content, lang):
    ...
    replacements = [
        ...
        ('HAN\'S, DNE, PENTA, LEAD, HSG, BODOR — if your machine uses standard auxiliary gas connections, it\'s compatible. We\'ll confirm before you buy.', bt.get('why5_desc', '')),
